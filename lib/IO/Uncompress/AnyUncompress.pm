...
use IO::Compress::Base::Common 2.080 ();
...
BEGIN
{
   local @INC = @INC;
   pop @INC if $INC[-1] eq '.';
   eval ' use IO::Uncompress::Adapter::Inflate 2.080 ;';
   eval ' use IO::Uncompress::Adapter::Bunzip2 2.080 ;';
   eval ' use IO::Uncompress::Adapter::LZO 2.080 ;';
   eval ' use IO::Uncompress::Adapter::Lzf 2.080 ;';
   eval ' use IO::Uncompress::Adapter::UnLzma 2.080 ;';
   eval ' use IO::Uncompress::Adapter::UnXz 2.080 ;';

   eval ' use IO::Uncompress::Bunzip2 2.080 ;';
   eval ' use IO::Uncompress::UnLzop 2.080 ;';
   eval ' use IO::Uncompress::Gunzip 2.080 ;';
   eval ' use IO::Uncompress::Inflate 2.080 ;';
   eval ' use IO::Uncompress::RawInflate 2.080 ;';
   eval ' use IO::Uncompress::Unzip 2.080 ;';
   eval ' use IO::Uncompress::UnLzf 2.080 ;';
   eval ' use IO::Uncompress::UnLzma 2.080 ;';
   eval ' use IO::Uncompress::UnXz 2.080 ;';
}
