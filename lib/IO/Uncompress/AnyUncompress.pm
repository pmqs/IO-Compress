...
BEGIN
{
   eval ' use IO::Uncompress::Adapter::Inflate 2.014 ;';
   eval ' use IO::Uncompress::Adapter::Bunzip2 2.014 ;';
   eval ' use IO::Uncompress::Adapter::LZO 2.014 ;';
   eval ' use IO::Uncompress::Adapter::Lzf 2.014 ;';

   eval ' use IO::Uncompress::Bunzip2 2.014 ;';
   eval ' use IO::Uncompress::UnLzop 2.014 ;';
   eval ' use IO::Uncompress::Gunzip 2.014 ;';
   eval ' use IO::Uncompress::Inflate 2.014 ;';
   eval ' use IO::Uncompress::RawInflate 2.014 ;';
   eval ' use IO::Uncompress::Unzip 2.014 ;';
   eval ' use IO::Uncompress::UnLzf 2.014 ;';
}
