...
use IO::Compress::RawDeflate 2.014 ;
use IO::Compress::Adapter::Deflate 2.014 ;
use IO::Compress::Adapter::Identity 2.014 ;
use IO::Compress::Zlib::Extra 2.014 ;
use IO::Compress::Zip::Constants 2.014 ;


use Compress::Raw::Zlib  2.014 qw(crc32) ;
BEGIN
{
    eval { require IO::Compress::Adapter::Bzip2 ; 
           import  IO::Compress::Adapter::Bzip2 2.014 ; 
           require IO::Compress::Bzip2 ; 
           import  IO::Compress::Bzip2 2.014 ; 
         } ;
}
