...
use IO::Compress::RawDeflate 2.088 ();
use IO::Compress::Adapter::Deflate 2.088 ;
use IO::Compress::Adapter::Identity 2.088 ;
...
BEGIN
{
    eval { require IO::Compress::Adapter::Bzip2 ; 
           import  IO::Compress::Adapter::Bzip2 2.088 ; 
           require IO::Compress::Bzip2 ; 
           import  IO::Compress::Bzip2 2.088 ; 
         } ;
         
    eval { require IO::Compress::Adapter::Lzma ; 
           import  IO::Compress::Adapter::Lzma 2.088 ; 
           require IO::Compress::Lzma ; 
           import  IO::Compress::Lzma 2.088 ; 
         } ;
}
